...
namespace vMenuClient
{
  public static class CommonFunctions
  {
    ...
    internal static bool DriveFollowTaskActive = false;
    ...
    /// Follows an entity
    /// </summary>
    public static void DriveFollowToggle(int targetEntity)
    {
      ClearPedTasks(Game.PlayerPed.Handle);
      if (DriveFollowTaskActive)
      {
        DriveFollowTaskActive = false;
        return;
      }

      DriveWanderTaskActive = false;
      DriveToWpTaskActive = false;
      DriveFollowTaskActive = true;
      ...
      TaskVehicleFollow(Game.PlayerPed.Handle, veh.Handle, targetEntity, GetVehicleModelMaxSpeed(model), 787004, 2);
    }
    /// <summary>
    /// Drives to waypoint
    /// </summary>
